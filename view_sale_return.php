        ...
        <div class="card">
          ...
          <div class="card-body">
            <table class="table credit_order" id="view_orders_tb">
              ...
              <tbody>
                <?php $q = mysqli_query($dbc, "SELECT * FROM orders_return ORDER BY order_id DESC");
                $c = 0;
                  ...
                  <tr>
                    ...
                    <td class="d-flex">
                      ...
                      <?php if (@$userPrivileges['nav_delete'] == 1 || $fetchedUserRole == "admin"): ?>
                        <a href="#" onclick="deleteAlert('<?= $r['order_id'] ?>','orders_return','order_id','view_orders_tb')"
                          class="btn btn-danger btn-sm m-1">Delete</a>
                      <?php endif; ?>


                      <a target="_blank" href="print_order.php?type=order_return&id=<?= $r['order_id'] ?>"
                        class="btn btn-admin2 btn-sm my-1">Print</a>
