...
if (isset($_REQUEST['add_category_name'])) {
	...
	if ($_REQUEST['categories_id'] == '') {
		...
		if (update_data($dbc, "categories", $data_array, "categories_id", $_REQUEST['categories_id'])) {
			...
			// Success message now set regardless of whether products exist
			$response = [
...
if (isset($_REQUEST['add_area_name'])) {
	$data_array = [
		'area_name' => $_REQUEST['add_area_name'],
		'area_status' => $_REQUEST['area_status'],
	];
	if ($_REQUEST['area_id'] == '') {
		if (insert_data($dbc, "areas", $data_array)) {
			# code...
			$response = [
		...
		if (update_data($dbc, "areas", $data_array, "area_id", $_REQUEST['area_id'])) {
			# code...
			$response = [
