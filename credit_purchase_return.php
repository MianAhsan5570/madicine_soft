...
");
            ...
            <div class="form-group row">
              ...
              <div class="col-6 col-sm-2 col-md-2" id="batch_div">
                ...
                <!-- <span class="text-center w-100 text-danger" id="batchQty"></span> -->
                      ...
                      while ($r = mysqli_fetch_assoc($q)) {
                        ...
                        <tr id="product_idN_<?= $r['product_id'] ?>">
                          ...
                          <td>
                            ...
                            <button type="button"
                              onclick="editPurchaseItem(<?= $r['product_id'] ?>,'<?= $r['batch_no'] ?>','<?= $r['expiry_date'] ?>',<?= $r['rate'] ?>,<?= $r['sale_rate'] ?>,<?= $r['quantity'] ?>,<?= $r['batch_id'] ?>)"
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td class="table-bordered">
                        <div class="form-group row">
                          <div class="col-sm-6">
                            <input type="number" min="0" class="form-control form-control-sm" id="paid_ammount" required
                              onkeyup="getRemaingAmount()" name="paid_ammount" value="<?= @$fetchPurchase['paid'] ?>">
