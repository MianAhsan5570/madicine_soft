...
");
            ...
            <div class="row g-2 align-items-end mb-3 form-compact">
              <!-- Product Code -->
              <!-- <div class="col-6 col-sm-2 col-md-1_5">
        <label class="form-label fs-6 mb-1">Code</label>
        <input type="text" class="form-control form-control-sm" id="get_product_code" name="product_code" autocomplete="off" placeholder="Code">
    </div> -->
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <option data-price="<?= $row["current_rate"] ?>" <?= empty($r['product_id']) ? "" : "selected" ?>
                        ...
                        <?= ucwords($row["product_name"]) ?>
                         <!-- | <?= ucwords(@$getBrand["brand_name"]) ?>
                        (<?= @$getCat["categories_name"] ?>) -->
                      </option>
                    <?php } ?>
                  </select>
              ...
              <!-- Batch No -->
              <div class="col-6 col-sm-2 col-md-1_5">
                <label class="form-label fs-6 mb-1">Batch</label>
                <input type="text" class="form-control form-control-sm" id="get_batch_no" placeholder="Batch No">
              </div>

              <!-- Expiry -->
              <div class="col-6 col-sm-2 col-md-1_5">
                <label class="form-label fs-6 mb-1">Expiry</label>
                <input type="date" class="form-control form-control-sm" id="get_expiry_date">
              </div>

              <!-- Purchase Price -->
              <div class="col-6 col-sm-2 col-md-1_5">
                <label class="form-label fs-6 mb-1">Pur. Price</label>
                <input type="number" min="0" step="0.01" class="form-control form-control-sm text-end"
                  id="get_product_price" placeholder="0.00">
              </div>

              <!-- Sale Price -->
              <div class="col-6 col-sm-2 col-md-1_5">
                <label class="form-label fs-6 mb-1">Sale Price</label>
                <input type="number" min="0" step="0.01" class="form-control form-control-sm text-end"
                  id="sale_product_price" placeholder="0.00">
              </div>

              <!-- Quantity -->
              <div class="col-6 col-sm-1_5 col-md-1">
                <label class="form-label fs-6 mb-1">Qty</label>
                <input type="number" min="1" class="form-control form-control-sm text-center" id="get_product_quantity"
