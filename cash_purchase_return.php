                ...
                <table class="table  saleTable" id="myDiv">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="table-bordered" id="getDiscount"><input onkeyup="getOrderTotal()" type="number" id="ordered_discount" class="form-control form-control-sm" value="<?= @empty($_REQUEST['edit_order_id']) ? "0" : $fetchPurchase['discount'] ?>" min="0" name="ordered_discount">
                      </td>
                    </tr>
                    <tr>
