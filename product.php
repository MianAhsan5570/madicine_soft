                ...
                <div class="form-group row">
                  ...
                  <div class="col-1 col-md-1">
                    ...
                    <button type="button" class="btn btn-danger btn-sm " style="display: none;"
                      id="cancelBrandBtn">Cancel</button>
                  </div>
                  <div class="col-sm-2">
              ...
              <table class="table dataTable col-12" style="width: 100%" id="product_tb">
                <thead>
                  <tr>
                    ...
                    <?php if ($get_company['stock_manage'] == 1): ?>
                      <th>Batch Info (No | Expiry | Qty)</th>
                ...
                <tbody>
                  ...
                  while ($r = mysqli_fetch_assoc($q)) {
                    ...
                    // Fetch batch details and calculate total stock
                    $total_stock = 0;
                    $batch_details = "";
                    ...
                    <tr>
                      ...
                      <?php if ($get_company['stock_manage'] == 1): ?>
                        ...
                        <?php else: ?>
                          <td><span class="badge p-1  badge-danger"><?= $total_stock ?></span> </td>
