              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <select class="form-control" id="categories_status" name="categories_status">
                    <option value="1" <?= (isset($categories['categories_status']) && $categories['categories_status'] == 0) ? "" : "selected" ?>>
                      Active
                    </option>
                    <option value="0" <?= (isset($categories['categories_status']) && $categories['categories_status'] == 0) ? "selected" : "" ?>>
                      Inactive
                    </option>
                  </select>
                </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a target="_blank" href="stock.php?type=simple&category=<?= $r['categories_id'] ?>"
                        class="btn btn-admin  btn-sm mx-1">Print Stock</a>
                      ...
                      <a target="_blank" href="stock.php?type=amount&category=<?= $r['categories_id'] ?>&stock=0"
                        class="btn btn-admin2  btn-sm mx-1">Print Stock With Amount + AQ</a>
